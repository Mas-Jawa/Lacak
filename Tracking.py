...
def process_number(number):
    api_key = '67b7e3453c6a8881913466hqo5d02a5'
    url = f"https://geocode.maps.co/search?q=address&api_key=67b7e3453c6a8881913466hqo5d02a5"
    url = f"https://geocode.maps.co/reverse?lat=latitude&lon=longitude&api_key=67b7e3453c6a8881913466hqo5d02a5"
    ...
    try:
        ...
        print(f"{Fore.GREEN}[+] Masukan Nomernya Ngab"
    ...
    # Handle exceptions, such as invalid phone numbers or connectivity issues.
        ...
        print(f"{Fore.RED}[-] Please specify a valid phone number (with country code)"
              " Cek koneksi internetmu Bangsat")
        sys.exit()
  ...
  # Import the OpenCageGeocode class from the opencage.geocoder module
    ...
    try:
        ...
        coder = OpenCageGeocode("67b7e3453c6a8881913466hqo5d02a5")
        query = location

        # Perform a goecoding query to obtain results.
...
def cli_argument():
    ...
    parser = argparse.ArgumentParser(description=" approximate location of a Phone number.")
...
get_api("".join(args.phone_number))
draw_map()
